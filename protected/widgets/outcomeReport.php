...
class outcomeReport extends DashPanel {
    ...
    private function search() {
        ...
        $query->where("(`doctype`=:typeA) OR (`doctype`=:typeB)",[':typeA'=>13,':typeB'=>14]);
        ...
        $this->content = \app\widgets\GridView::widget( array(
            ...
            'columns' => array(
                ...
                array(
                    'attribute' => 'docnum',
                    //'value' => '$data->docnum',
                    'value' => function($data){return \yii\helpers\html::a(\yii\helpers\html::encode($data->total),\yii\helpers\BaseUrl::base().("/docs/view/".$data->id));},
                    'format' => 'raw',
                ),
                //'refnum2',
                array(
