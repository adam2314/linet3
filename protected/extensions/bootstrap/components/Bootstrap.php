...
class Bootstrap extends CApplicationComponent {
    ...
    public function registerYiiCss() {
        ...
        $cs->registerCSSFile(Yii::app()->createAbsoluteUrl('/assets/lib/select2/select2.css'));
        Yii::app()->clientScript->registerScriptFile(Yii::app()->createAbsoluteUrl('/assets/lib/select2/select2.js'), CClientScript::POS_HEAD);
