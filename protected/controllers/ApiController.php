...
class ApiController extends RightsController{
        // Members
    /**
    ...
    public function actionList($model){
        ...
        if(isset($this->allowed[$model])){
            $modelName=$this->allowed[$model];
    ...
    public function actionDelete($model,$id) {
        ...
        if(isset($this->allowed[$model])){
            ...
            $this->_sendResponse(501, sprintf(
                    'Error: Mode <b>delete</b> is not implemented for model <b>%s</b>',
                    $model) );
            Yii::app()->end();
        }
