...
<div class="alert">
    <h4>אזהרה:</h1><br />
למרות שרישיון ה-AGPL v3.0  מאפשר לך לשנות את קוד התוכנה, כל שינוי כאמור בקוד, יוצר למעשה גרסה חדשה לתוכנה, ובכך מבטל אוטומאטית את אישור הרישום של רשות המסים לגרסת תוכנת לינט שנמצאה בשימושך עד לפני השינוי.<br /> 
