...
<div class="body">
    <div class="docHead">
        <div class="fromBox">
            ...
            <?= $company['address']; ?>, <?= $company['city']; ?> ,<?= $company['zip']; ?><br />
            <?= Yii::t('app', 'Phone'); ?>: <?= $company['phone']; ?><br />
            <?= Yii::t('app', 'Fax'); ?>: <?= $company['fax']; ?><br />
            <?= $company['website']; ?><br />

            <?= Yii::t('app', 'VAT No.'); ?>: <?= $company['vatnum']; ?><br />
        </div>
        ...
        <div  class="logo">
            ...
            if(Linet3Helper::hasLogo()){
                echo Html::img(Linet3Helper::getLogo(),['class'=>'logo']);
            }
            ?>
        </div>
    </div>
            ...
            <table class="printtbl table">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td class='Total'><?= (($model->disType) ? "%" : "") . $model->discount.$model->currency_id; ?></td>
                    ...
                    <tr>
                        ...
                        <td class='Total'><?= $model->sub_total.$model->currency_id; ?></td>
                    ...
                    <tr>
                        ...
                        <td class='Total'><?= $model->vat.$model->currency_id; ?></td>
                    ...
                    <tr>
                        ...
                        <td class='Total'><?= $model->novat_total.$model->currency_id; ?></td>
                    ...
                    <tr>
                        ...
                        <td class='Total'><?= $model->total.$model->currency_id; ?></td>
