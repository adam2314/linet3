...
(7, 'Opening Balances', 'transaction/openbalance', NULL, 1),
(8, 'Contact Item', 'rm/admin', NULL, 12),
(9, 'Tax Category For Items', 'ItemVatCat/admin', NULL, 1),
...
(32, 'Expense', '', 'glyphicon glyphicon-shopping-cart', 0),
(33, 'Manage Suppliers', 'accounts/index/1', 'type=>1', 32),
(34, 'Purchase Order', 'docs/create/10', NULL, 16),
(35, 'Insert Business Expense', 'docs/create/13', NULL, 32),
(36, 'Insert Assets Expense', 'docs/create/14', NULL, 32),
(37, 'Cash Register', NULL, 'glyphicon glyphicon-usd', 0),
(38, 'Receipt', 'docs/create/8', NULL, 37),
(39, 'Bank Deposits', 'deposit/admin', NULL, 37),
(40, 'Supplier Payment', 'outcome/create', NULL, 37),
...
(44, 'Bank Sheet Import', 'bankbook/admin', NULL, 43),
(45, 'Bank Recon.', 'bankbook/extmatch', NULL, 43),
(46, 'Show Bank Recon', 'bankbook/edispmatch', NULL, 43),
(47, 'Accounts Recon.', 'match/intmatch', NULL, 43),
(48, 'Display Recon.', 'match/dispmatch', NULL, 43),
(49, 'Reports', NULL, 'glyphicon glyphicon-stats', 0),
(50, 'Display Transactions', 'reports/journal', NULL, 49),
(51, 'Customers Debits', 'reports/owe', NULL, 49),
(52, 'Profit And Loss', 'reports/profloss', NULL, 49),
(53, 'Monthly Prof. And Loss', 'reports/mprofloss', NULL, 49),
(54, 'VAT Calculation', 'reports/vat', NULL, 49),
(55, 'Balance', 'reports/balance', NULL, 49),
(56, 'In Advance Income Tax Pay', 'reports/taxrep', NULL, 49),
