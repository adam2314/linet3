...
('company.path', 'TEMP', 'string', 1),
('company.pdfprint', 'true', 'boolean', 0),
('company.phone', '', 'string', 0),
('company.po', '', 'string', 0),
('company.seccur', 'AED', 'list(Currecies)', 0),
('company.stock', 'false', 'boolean', 0),
('company.tax.irs', '1', 'select({1:"monthly",2:"bi-monthly"})', 0),
('company.tax.rate', '10', 'integer', 0),
('company.tax.vat', '1', 'select({1:"monthly",2:"bi-monthly"})', 0),
('company.transaction', '1', 'integer', 1),
('company.vat.id', '', 'integer', 0),
('company.website', '', 'string', 0),
('company.zip', '', 'string', 0),
('company.mail.server', '', 'string', 0),
('company.mail.user', '', 'string', 0),
('company.mail.password', '', 'string', 0),
('company.mail.address', '', 'string', 0),
('company.mail.port', '', 'string', 0),
('company.mail.ssl', '', 'boolean', 0),
