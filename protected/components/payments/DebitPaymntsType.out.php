...
class DebitPaymntsType {
    ...
    private $operation = 'DebitPaymntsType';
	...
	<form id="billForm" method="post" action="' . Yii::app()->createUrl('/payment/bill') . '">
                ...
                <input id="billPaymentsNo" name="bill[paymentsNo]" value="1" />
                <label>First Payment:</label>
                <input id="billfirstPymnt" name="bill[firstPymnt]" value="1" />
    ...
    public function bill() {//needs to have!
        ...
        $params = array(
            ...
            'total' => $this->total, //
            'currency' => '1',
            'paymentsNo' => $this->paymentsNo,
            'firstPymnt' => $this->firstPymnt,
            'cvv2' => $this->cvv2, //
            'id' => $this->id, //
            'authNum' => '', //
